...
__all__ = ["auth_router", "emails_router", "analytics_router", "users_router", "email_management_router", "ml_router", "action_management_router", "proposed_actions_router", "flow_buckets_router"]
...
from .flow_buckets import router as flow_buckets_router